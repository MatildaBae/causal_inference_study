...
- 처리 모델이 통제 모델의 정보를 고려한 상태에서 예측 수행
- 다음, 처리 모델의 예측값과 통제 모델의 예측값 간의 차이를 계산하여 Uplift 효과를 추정
"""
...
- 처리 모델의 예측을 통제 모델의 입력으로 사용하는 방식(반대)
- 통제 모델이 처리 모델의 정보를 반영한 상태에서 통제 그룹의 결과를 예측
- 그 차이를 계산하여 Uplift 효과 추정
"""
